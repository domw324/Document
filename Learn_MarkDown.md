...
## 함께 활용하면 좋은 에디터
##### Visual Code
말할 것 없이, Windows OS를 사용하는 사용자들에게는 무료로 제공되는 에디터인 Visual Code이다. 물론 프로그램 자체가 가볍지 않아서 설치에 부담스럽게 느낄 수도 있지만, 그 외의 여러 언어 에디터도 함께 사용할 수 있다는 장점이 있다.
##### Typora
Mac OS를 사용하는 사용자들에게 굉장히 편리한 에디터이다. 여러 단축키들을 지원한다. 또한 GUI를 통해 속성을 지정해 문서를 작성하면 반대로 마크다운 코드로 변환시켜준다.
---
# 코드 설명
## 머릿말
